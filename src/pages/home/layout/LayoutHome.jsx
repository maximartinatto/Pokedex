...
export default function LayoutHome() {
  ...
  const obtenerSearch = (event) => {

    const texto = event.toLowerCase()
    setSearch(texto)
    setXpage(1)
  }
  ...
  return (
    <div className={css.layout}>
      ...
      <section className={css.sectionPagination}>
        <div className={css.divPagination}>
          <span className={css.itemIzquierdo}
          
          onClick={() => {
            if (xpage === 1) {
              return console.log("Me es imposible retroceder");
            }
            setXpage(xpage - 1);
          }}
